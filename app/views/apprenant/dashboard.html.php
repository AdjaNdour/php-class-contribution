  ...
  <div class="bg-surface rounded-xl border border-gray-100 p-4">
    <div class="w-8 h-8 rounded-lg bg-success/10 flex items-center justify-center text-success mb-3">
      <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        <path d="M12 2v20M17 6.5c-1-1.3-2.9-2-5-2-3 0-5 1.3-5 3.5S9 11.5 12 12s5 1.3 5 3.5-2 3.5-5 3.5c-2.1 0-4-.7-5-2" stroke-linecap="round" stroke-linejoin="round" />
      </svg>
    </div>
    <p class="text-[11px] font-semibold tracking-wide text-text-muted">TOTAL COTISATION</p>
